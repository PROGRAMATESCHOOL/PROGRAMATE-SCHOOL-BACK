...
This is a Backend project which we focus on making a platform for some students, in this project we use mongoo DB and apply an extension called mongoose among others, let's see more about this project.
</div>
